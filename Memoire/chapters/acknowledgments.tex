...
Ma gratitude s'étend aux experts et chercheurs qui ont participé à l'évaluation technique de SecureIoT-VIF. Leurs retours critiques et constructifs ont été essentiels pour valider l'efficacité et la robustesse de l'architecture développée.

Je remercie les professionnels de l'industrie IoT qui ont accepté de tester et d'évaluer SecureIoT-VIF dans des contextes variés, fournissant des données précieuses sur la praticité et l'applicabilité de l'architecture proposée.

\section*{Support technique et communautaire}

Mes remerciements à la \textbf{communauté ESP-IDF et mbedTLS} pour leur documentation excellente et le support technique qui ont facilité le développement de cette architecture de recherche.
