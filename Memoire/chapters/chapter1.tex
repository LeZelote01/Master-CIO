...
\begin{itemize}
    \item Implémenter la Configuration Standard de SecureIoT-VIF sur plateforme ESP32 avec optimisations de performance
...
\begin{itemize}
    ...
    \item Mesurer l'impact sur les performances du système et la consommation énergétique
