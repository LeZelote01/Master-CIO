...
Cette revue de littérature révèle que malgré les avancées significatives dans la sécurité des firmwares IoT, des lacunes importantes subsistent. Les solutions existantes peinent à offrir un équilibre satisfaisant entre sécurité, performance et praticité de déploiement. Notre contribution vise à combler ces lacunes en proposant SecureIoT-VIF, un framework professionnel qui combine efficacité de protection, overhead acceptable, et architecture évolutive. L'approche adoptée permet un déploiement immédiat avec des mécanismes de sécurité robustes, tout en établissant les fondations pour une évolution future vers des fonctionnalités avancées (vérification temps réel, HSM matériel, machine learning adaptatif).
