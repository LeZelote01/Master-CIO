...
\usepackage{titlesec}
\usepackage{tocloft}
% Configuration pour bibtex (au lieu de biber) avec style numérique
...
\hypersetup{
    ...
    urlcolor=cyan,
    citecolor=red,
    pdftitle={SecureIoT-VIF : Architecture à Deux Niveaux pour la Sécurité des Firmwares IoT},
    pdfauthor={Nom de l'étudiant},
    pdfsubject={Mémoire de Master},
    pdfkeywords={IoT, Firmware Security, Two-Level Architecture, ESP32, Standard Configuration, Expert Configuration, mbedTLS, Embedded Security, Research}
}
...
\newcommand{\université}{Université [Nom de votre université]}
\newcommand{\faculté}{Faculté [Nom de votre faculté]}
\newcommand{\département}{Département [Nom de votre département]}
\newcommand{\titre}{SecureIoT-VIF : Architecture à Deux Niveaux pour la Sécurité des Firmwares IoT - Conception, Implémentation et Validation d'une Solution Extensible basée sur ESP32 et Cryptographie mbedTLS}
